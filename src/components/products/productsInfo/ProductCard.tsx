...
interface ProductCardProps {
  ...
  reviews?: number; // optional reviews
...
export default function ProductCard({
  ...
  return (
    <div
      className="group relative flex flex-col overflow-hidden rounded-xl border bg-white border-gray-100 transition-all duration-150 ease-in-out hover:border-emerald-500 cursor-pointer"
      onClick={onClick}
    >
      {/* Stock Badge */}
      ...
      <div className="relative w-full min-h-48 lg:h-48 xl:h-52">
        <div className="relative w-full h-full overflow-hidden bg-gray-100 flex justify-center items-center">
          ...
          <div className="absolute lg:bottom-0 bottom-4 lg:group-hover:bottom-4 inset-x-1 opacity-100 flex justify-center lg:opacity-0 lg:invisible group-hover:opacity-100 group-hover:visible transition-all">
            <button className="flex items-center gap-1 text-xs bg-white text-gray-700 rounded-full px-3 py-1 shadow hover:text-emerald-500 hover:bg-gray-100 cursor-pointer">
              <FiEye /> Quick View
            </button>
          </div>
